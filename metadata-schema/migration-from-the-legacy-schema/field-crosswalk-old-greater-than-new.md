...
| Sample type (and subtype)                   | Object type                                         | Mapped through the object-type list ([value mapping](sample-type-to-object-type.md)). The original type is kept as **legacy sample type** |
...
| Material (top-level classification)         | General material type                               | Mapped through the material-type list ([value mapping](classification-to-material-type.md)). Original value kept as **legacy top-level classification** |
| Classification                              | Material types                                      | Mapped through the material-type list ([value mapping](classification-to-material-type.md)). Original value kept as **legacy classification**. A sample can have more than one material type now |
