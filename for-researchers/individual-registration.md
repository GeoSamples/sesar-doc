...
Individual registrations are used for registering a single sample. For multiple sample registrations, please see the 'Batch Registration Guide'. Each step is outlined below.&#x20;
