...
Registering your samples with SESAR contributes to the National Science Foundations mission of open access to data and allows your samples to be discovered beyond your personal or institutional catalog. The National Science Foundation allows for researchers to budget expenses for the preparation of research data for distribution. ([NSF Proposal and Award Policies and Procedures Guide](https://www.nsf.gov/publications/pub_summ.jsp?ods_key=pappg) Chapter II.C.2.g.(vi).b)
