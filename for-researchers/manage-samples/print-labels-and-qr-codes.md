...
3. On the popup that displays the labels, you can change up to three fields to print on your label. We recommend having the first field as ‘Sample Name’. The IGSN is not customizable. You can also change the ‘Label Sheet Layout’ to OL75/Avery 5161 or Laser Cryo-Tags.
4. Click the 'Save to PDF File' button to download. For a large number of samples, the PDFs will automatically be divided and downloaded as multiple files.
5. When printing the saved .pdf, set the paper type as A4, left and right margin should be 1 inch. (We suggest printing a test page first before printing on the labels.)

<img src="../.gitbook/assets/unknown (21).png" alt="" height="563" width="624">
